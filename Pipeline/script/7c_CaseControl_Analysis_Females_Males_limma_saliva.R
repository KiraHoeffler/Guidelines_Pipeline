...
model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + anc_PC1")
...
model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + anc_PC1")
model_formula <- update(model_formula, paste("~ . -", high_vif))
...
model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + anc_PC1")
model_formula <- update(model_formula, paste("~ . -", high_vif))
...
model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + Ctrl_PC11 + Ctrl_PC12 + Ctrl_PC13 + Ctrl_PC14 + Ctrl_PC15 + anc_PC1")
model_formula <- update(model_formula, paste("~ . -", high_vif))
...
model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + anc_PC1 + anc_PC2")
model_formula <- update(model_formula, paste("~ . -", high_vif))
...
model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + anc_PC1 + anc_PC2")
model_formula <- update(model_formula, paste("~ . -", high_vif))
...
if (nrow(samples) > 25){
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 +Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + anc_PC1 + anc_PC2")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
...
if (nrow(samples) >= 35){
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + Ctrl_PC11 + Ctrl_PC12 + Ctrl_PC13 + Ctrl_PC14 + Ctrl_PC15 + anc_PC1 + anc_PC2")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
...
if (nrow(samples) >= 25){
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + anc_PC1 + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + anc_PC1 + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + anc_PC1  + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
...
if (nrow(samples) >= 35){
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + Ctrl_PC11 + Ctrl_PC12 + Ctrl_PC13 + Ctrl_PC14 + Ctrl_PC15 + anc_PC1 + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
...
if (nrow(samples) >= 35){
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + anc_PC1 + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5 + anc_PC6 +anc_PC7 +anc_PC8 +anc_PC9 +anc_PC10")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + anc_PC1 + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5 + anc_PC6 +anc_PC7 +anc_PC8 +anc_PC9 +anc_PC10")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + anc_PC1  + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5  + anc_PC6 + anc_PC7 +anc_PC8 +anc_PC9 +anc_PC10")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
  ...
  model_formula <- as.formula(" ~ CaseCtrl + Sex + Age + smoking + cell_PC1 + cell_PC2 + Ctrl_PC1 + Ctrl_PC2 + Ctrl_PC3 + Ctrl_PC4 + Ctrl_PC5 + Ctrl_PC6 + Ctrl_PC7 + Ctrl_PC8 + Ctrl_PC9 + Ctrl_PC10 + Ctrl_PC11 + Ctrl_PC12 + Ctrl_PC13 + Ctrl_PC14 + Ctrl_PC15 + anc_PC1 + anc_PC2 + anc_PC3 + anc_PC4 + anc_PC5  + anc_PC6 +anc_PC7 +anc_PC8 +anc_PC9 +anc_PC10")
  model_formula <- update(model_formula, paste("~ . -", high_vif))
